...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет и выводит урон от атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет и выводит эффективность блока."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит информацию о применении спец. умения."""
    if char_class == 'warrior':
...
def main():
    """Объединяет приветствие, выбор персонажа и тренирови."""
